...
function scrapeFromEbay($search, $order='', $auction='', $buy_it_now='', $condition='')
{
    ...
    $products = scrappe($search, $order, $auction, $buy_it_now, $condition);
    return $products;
}

// Function to scrape product data from Amazon
function scrapeFromAmazon($search, $order, $filters)
{
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET') {
        ...
        switch ($page) {
            case 'ebay':
                ...
                break;
            case 'amazon':
                $products = scrapeFromAmazon($search, $order, $filters);
                break;
            case 'mercadolibre':
